...
Model files are not tracked in Git. Download the weights archive from Google Drive:

```text
https://drive.google.com/file/d/1wMSFoHUNaM8a0aDyA7UJ44i_cNgz1b_u/view?usp=sharing
```
